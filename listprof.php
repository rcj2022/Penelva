...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    <a class="navbar-brand" href="">Relação de Professores</a>
...
<div class="table-responsive">
    ...
    <caption class="text-center text-light fs-4">Clique no botão acima para cadastrar um novo professsor</caption>
    </table>
    </div>
</div>
