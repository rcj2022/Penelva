<?php
    ...
    if(!empty($_GET['search']))
    {
        ...
        $data = $_GET['search'];
        $sql = "SELECT * FROM escola WHERE id LIKE '%$data%' or nome LIKE '%$data%' or cpf LIKE '%$data%' ORDER BY id DESC";
...
<head>
            ...
            <link rel="shortcut icon" href="imagem/aluno.png" type="image/x-icon">
...
<img src="imagem/aluno.png" alt="" class="imagem">
  <div class="container-fluid">
       
    <a class="navbar-brand">Alunos Cadastrados</a>
...
<div class="table-responsive">
    <div class="container mt-4">
        <a class='btn btn-sm btn-success' href='cadaluno.php'>
    ...
    <thead class="text-light fs-5 bg-primary ">
        ...
        <th scope="col">SUS</th>
        <th scope="col">Pai</th>
        <th scope="col">Contato do Pai</th> 
        <th scope="col">Mãe</th>  
        <th scope="col">Contato da Mãe</th> 
    ...
    <?php
        while($dados = mysqli_fetch_assoc($result))
        {
            ...
            echo "<td>".$dados['contpai']."</td>";
            echo "<td>".$dados['mae']."</td>";
            echo "<td>".$dados['contmae']."</td>";
            echo "<td>".$dados['rua']."</td>";
            echo "<td>".$dados['bairro']."</td>";
            echo "<td>".$dados['cidade']."</td>";
            echo "<td>".$dados['estado']."</td>";
            echo "<td>".$dados['bolsa']."</td>";
    ...
    <caption class="text-center text-light fs-4">Clique no botão acima para cadastrar um novo aluno</caption>
    </table>
    </div>
</div>
...
search.addEventListener("keydown", function(event){
 ...
 function searchData()
 {
    window.location ='consult.php?search=' + search.value;
